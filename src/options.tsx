  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            {settings.model === 'portkey' && (
              <div>
                ...
                />
                <p className="mt-2 text-sm text-gray-500">
                  Virtual key for model routing and configuration. Get from{' '}
                  <a
                    href="https://app.portkey.ai"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-lg p-4 bg-white">
              <h3 className="text-lg font-medium text-gray-900 mb-3">
                {settings.language === 'chinese' ? '中文 (Chinese)' : 'English'} Prompt
                Configuration
              </h3>
              ...
              <div className="space-y-4">
                <div>
                      ...
                      setSettings(prev => ({
                        ...
                        customPrompts: {
                          ...
                          [settings.language]: {
                            ...
                            userPrompt:
                              prev.customPrompts?.[settings.language]?.userPrompt ||
                              (settings.language === 'chinese'
                                ? '请为以下网页内容提供一个简洁、结构清晰的中文摘要，突出主要观点和关键信息：\n\n{text}'
                                : 'Please provide a concise, well-structured summary of this webpage content, highlighting the main points and key information:\n\n{text}'),
                            temperature:
                              prev.customPrompts?.[settings.language]?.temperature || 0.5,
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    This defines the AI assistant's role and behavior for{' '}
                    {settings.language === 'chinese' ? 'Chinese' : 'English'} summaries
                  </p>
                </div>
                    ...
                    onChange={e =>
                      setSettings(prev => ({
                        ...
                        customPrompts: {
                          ...
                          [settings.language]: {
                            systemPrompt:
                              prev.customPrompts?.[settings.language]?.systemPrompt ||
                              (settings.language === 'chinese'
                                ? '你是一个有用的助手，专门总结网页内容。请提供简洁、结构清晰的摘要，突出主要观点和关键信息。'
                                : 'You are a helpful assistant that summarizes web page content. Provide a concise, well-structured summary highlighting the main points and key information.'),
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setSettings(prev => ({ ...prev, cacheMaxSize: parseInt(e.target.value) || 100 }))
                }
                className="block w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 text-base"
              />
              <p className="mt-2 text-sm text-gray-500">
            ...
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setSettings(prev => ({ ...prev, cacheExpiryDays: parseInt(e.target.value) || 1 }))
                }
                className="block w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 text-base"
              />
              <p className="mt-2 text-sm text-gray-500">
                How many days to keep cached summaries (1-30). Expired entries are automatically
                removed.
              </p>
            </div>
          </div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900">
                        {settings.cacheExpiryDays || 1} day
                        {(settings.cacheExpiryDays || 1) > 1 ? 's' : ''}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        {status && (
          <div
            className={`px-4 py-3 rounded-md text-sm whitespace-pre-line ${
              status.type === 'success'
          ...
          <div className="border-l-4 border-purple-500 pl-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Custom Prompt Configuration:</strong> Added ability to edit default
                  prompts for both Chinese and English summaries
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Prompt Parameters:</strong> Customizable temperature and max tokens for
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Prompt Preview:</strong> Live preview of how custom prompts will be used
                  with sample text
                </span>
              </div>
            </div>
          ...
          <div className="border-l-4 border-blue-500 pl-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Portkey Integration:</strong> Added support for Portkey AI gateway with
              ...
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Enhanced Model Support:</strong> Now supports Claude, OpenAI, and Portkey
          ...
          <div className="border-l-4 border-gray-400 pl-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Cache Configuration:</strong> Added user-configurable cache size limit and
                  expiry days in options page
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Unified Cache Button:</strong> Consolidated cache status and summarize
                  button with color coding (green for cached, blue for fresh)
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Options Page:</strong> Added dedicated full-page options interface with
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Interface Cleanup:</strong> Removed resize functionality, cleaned up
                  legacy CSS files, simplified popup navigation
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Layout Improvements:</strong> Doubled popup width to 800px, fixed
                  horizontal scrollbar issues using Tailwind
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-teal-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Auto-summarization:</strong> Added automatic summarization when plugin
                  opens with proper timing fixes
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-4 border-gray-400 pl-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Foundation:</strong> Core extension architecture with React, Tailwind, and
                  cache system
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-gray-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>AI Integration:</strong> Claude and OpenAI API support with intelligent
                  caching
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="w-2 h-2 bg-gray-500 rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Multi-language:</strong> Chinese and English summarization support
                </span>
              </div>
            </div>
          </div>
